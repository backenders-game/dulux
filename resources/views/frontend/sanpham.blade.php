      ...
      <section class="col-sm-12 focus-outline">
        ...
        <div class="region region-content focus-outline">
          <section id="block-system-main" class="block block-system clearfix focus-outline" role="navigation">
            <div data-quickedit-entity-id="node/3" class="focus-outline">
              <div class="panel-display boxton clearfix radix-boxton focus-outline">
                <div class="container-fluid focus-outline">
                  <div class="row focus-outline">
                    <div class="col-md-12 radix-layouts-content panel-panel focus-outline">
                      <div class="panel-panel-inner focus-outline">
                        ...
                        <div class="panel-pane pane-block pane-bean-product-overview-middle pane-bean focus-outline">
                          <div class="pane-content focus-outline">
                            <div class="entity entity-bean bean-bean-block clearfix focus-outline" about="/block/product-overview-middle" typeof="">
                              <div class="content focus-outline">
                                <div class="field field-name-field-bean-body-text field-type-text-with-summary field-label-hidden focus-outline">
                                  <div class="field-items focus-outline">
                                    <div class="field-item even focus-outline">
                                      <div class="container-cstm focus-outline">
                                        <div class="prdct-overview focus-outline">
                                          <div class="row no-margin no-padding focus-outline">
                                            <div class="row-3">
                                              <div class="cstm-col-md-4 flourishProducts-processed" style="height: 239px;">
                                                <div class="img-holder "><a href="/vi/san-pham/son-phu" title="Sơn" tabindex="25"><img alt="" class="img-responsive center-block" src="https://383195fa362279d182f5-837f1281aae466a1e3ac27b4004c7f6b.ssl.cf3.rackcdn.com/dulux-son.jpg"></a></div>
                                                <div class="text-holder">
                                                  <p class="text-center fs24"><a href="/vi/san-pham/son-phu" title="Sơn" tabindex="26">Sơn</a></p>
                                                </div>
                                              </div>
                                              <div class="cstm-col-md-4 flourishProducts-processed" style="height: 239px;">
                                                <div class="img-holder "><a href="/vi/san-pham/san-pham-phu-tro" title="Sản phẩm phụ trợ" tabindex="27"><img alt="" class="img-responsive center-block" src="https://383195fa362279d182f5-837f1281aae466a1e3ac27b4004c7f6b.ssl.cf3.rackcdn.com/wysiwyg/packshot_274_x_159.png"></a></div>
                                                <div class="text-holder">
                                                  <p class="text-center fs24"><a href="/vi/san-pham/san-pham-phu-tro" title="Sản phẩm phụ trợ" tabindex="28">Sản phẩm phụ trợ</a></p>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
